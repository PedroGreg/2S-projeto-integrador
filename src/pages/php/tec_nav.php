<aside class="display-flex">
    ...
    <nav>
            ...
            <div class="sidebar-mobile" id="sidebar-mobile">
                <ul>
                    ...
                    <li><a class="links" href="./tec_chamados_abertos.php">Chamados abertos</a></li>
                    <li><a class="links" href="./tec_chamados_designados.php">Chamados designados</a></li>
                    <li><a class="links" href="./tec_chamados_concluidos.php">Chamados concluídos</a></li>
                </ul>
            </div>
        </nav>
    <section id="navbar-dir" class="display-flex-column">
        ...
        <div id="navbar-dir-ancoras" class="display-flex-column">
            <div class="links navbar-dir-a display-flex">
