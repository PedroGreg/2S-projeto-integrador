...
<body>
    <main>
        ...
        <div id="form-login">
            <form action="../php/login/validacao.php" method="post">
                <fieldset>
                    <legend><b>LOGIN</b></legend>
                    <div class="divInput">
                        <label for="email" class="labelUser">Email</label>
                        <input type="email" value="<?php print_r($_SESSION['email']); ?>" name="email" id="email" class="inputUser" required>
                    </div>
                    <div class="divInput">
                    ...
                    <p style="margin-top: 10px;">Ainda não cadastrado? <a href="./cadastro.php">Cadastre-se Aqui!</a></p>
