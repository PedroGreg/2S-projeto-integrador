...
<body class="display-flex">
    ...
    <main>
        <section id="hero" class="display-flex-column">
            ...
            <form method="" action="./chamado_concluido.php">
                <div class="form-div">
                ...
                <div class="form-div">
                    <label for="hora">TAC</label>
                    <input type="time" id="hora" name="horaAtual">
                </div>
                <div class="form-div">
                ...
                <div class="form-div">
                    <label for="obs">Observação do técnico</label>
                    <textarea rows="3" name="obs" id="obs"></textarea>
                </div>
            </form>
            <div id="descricao-button">
                <button class="botao button-cian" id="meuBotao">CONCLUIR CHAMADO</button>
            </div>
        </section>
    </main>
