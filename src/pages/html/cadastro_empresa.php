...
<body>
    <main>
        ...
        <div id="form-login">
            <form action="../php/cadastrarEmpresa.php" method="post">
                <fieldset>
                    <legend><b>CADASTRO EMPRESA</b></legend>
                    <div style="margin-bottom: 40px;">
                        <p><?php // if (isset($_SESSION['empresa'])) echo $_SESSION['empresa'] ?></p>
                        </div>
                        <div class="divInput">
                            <label for="nome" class="labelUser">Nome da Empresa</label>
                        ...
                        <div class="divInput">
                            <label for="cnpj" class="labelUser">CNPJ</label>
                        ...
                        <div class="divInput">
                            <label for="endereco" class="labelUser">Endereco</label>
