<?php
session_start();
if (!isset($_SESSION["codigo"]) || strlen($_SESSION["codigo"]) != 6){
...
<body>
    <main>
        ...
        <div id="form-login">
            <form action="../php/cadastroAdministradorInicial.php" method="post">
                <fieldset>
                    <legend><b>CADASTRO ADMINISTRADOR</b></legend>
                    <div style="margin-bottom: 40px;">
                        <p><?php if (isset($_SESSION['codigo']))
                            echo "O código da sua empresa é: " . $_SESSION['codigo'] ?>
                            </p>
                        </div>
                        <div class="divInput">
                            <label class="labelUser" for="nome">Nome Completo</label>
